...
public class LoginActivity extends AppCompatActivity {
    ...
    private LoginActivityShowType isInFingerprintMode;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menuChangeLoginMethod:
                if(isInFingerprintMode == LoginActivityShowType.login_fingerprint)
                {
                    PasswordSetCheck();
                }
                else if(isInFingerprintMode == LoginActivityShowType.login_text) {
                    setContentView(R.layout.layout_fingerprint_login);
                    isInFingerprintMode = LoginActivityShowType.login_fingerprint;
                }
                break;
    ...
    private void PasswordSetCheck(){
        ...
        System.out.println("@@@@@@@@@@@@@PW@@@@@@@@@@@" + pref.getString("Password",""));
        editor = pref.edit();
    ...
    public void PasswordRequest(){
        ...
        isInFingerprintMode = LoginActivityShowType.login_text;
